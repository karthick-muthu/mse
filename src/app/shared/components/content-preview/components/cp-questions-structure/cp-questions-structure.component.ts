import { Component, OnDestroy, OnInit, HostListener, ChangeDetectorRef, ViewEncapsulation } from '@angular/core';
...
import { MathquillEditorOptions } from '../../../questions/mathquill-editor-options.model';
import { QuestionsComponent } from '../../../questions/questions.component';
import { WorsheetModalComponent } from '../../../questions/worsheet-modal/worsheet-modal.component';
import { SparkieAlertsComponent } from '../../../questions/sparkie-alerts/sparkie-alerts.component';

@Component({
  selector: 'ms-cp-questions-structure',
  templateUrl: './cp-questions-structure.component.html',
  styleUrls: ['./cp-questions-structure.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CpQuestionsStructureComponent implements OnInit, OnDestroy {
  question: any;
  orientation: string;
  displayType: string;
  ...
  private setElementFocus(element: any, ignoreValue: boolean) {
    let elementValue,
      ...
      focusSet = false;
    htmlInputElement = <HTMLInputElement>document.getElementById(element);
    questionElement = <HTMLElement>document.getElementsByClassName('question-content')[0];
