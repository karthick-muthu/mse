...
@Component({
  selector: 'ms-cp-questions-footer',
  templateUrl: './cp-questions-footer.component.html',
  styleUrls: ['./cp-questions-footer.component.scss']
})
export class CpQuestionsFooterComponent implements OnChanges, OnDestroy {
